...
| :---: | :---: | :--- | :--- | :--- | :--- |
| ✅ | 1 | **RSI (14)** | Momentum | Identifies overbought (>70) / oversold (<30) conditions for reversals. | Add divergence detection (price vs. RSI). |
| ✅ | 2 | **EMA (9 & 21)** | Trend | Dynamic support/resistance; short-term trend direction (bullish when 9 > 21). | Plot on chart; trigger cross-over alerts. |
